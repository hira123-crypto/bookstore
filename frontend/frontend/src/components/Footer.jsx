...
function Footer() {
  return (
    <footer className="bg-gray-100 dark:bg-slate-900 text-gray-800 dark:text-white mt-10">
      <div className="max-w-6xl mx-auto px-4 py-10 flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <nav className="flex flex-wrap justify-center gap-6">
          ...
          <a href="#" className="hover:text-pink-500 transition-colors">Jobs</a>
          <a href="#" className="hover:text-pink-500 transition-colors">Press kit</a>
        </nav>
      ...
      <div className="border-t border-gray-300 dark:border-gray-700 text-center py-4 text-sm">
        © 2024 - All rights reserved by ACME Industries Ltd
      </div>
    </footer>
  );
}
